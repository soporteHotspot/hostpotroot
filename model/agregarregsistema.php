...
require("../require/connect_db.php");
	...
	mysqli_query($mysqli,"INSERT INTO `sistema` (`id`, `sistema`, `logo`, `idusuario`, `idpassword`, `texto`, `zona`, `moneda`, `modo`)  VALUES ('1','$nombre','$logo','$iduser', '$idpass','$text','$zone', '$moneda', '$modo')");		
   $data=1;
