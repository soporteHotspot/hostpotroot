...
//$mpdf = new \Mpdf\Mpdf(['setAutoBottomMargin' => 'stretch']);	
 ...
 $mpdf->WriteHTML('<columns column-count="8"  column-width="33%"  column-gap="2">');
...
$mpdf->WriteHTML('<table style="width:100%;    margin-top:1px;   border: 1px dotted black;" 
  ...
  <tr>
      <th   rowspan="5"   ><img style="width:78px; margin:1px; "   src="'.$qrcode.'" />  </th>
      ...
      <tr>  <th style="width:3px;  "    >  </th>
        <td style="text-align: left;  color:black;  border:0px ;  height: 20px; ">
 ...
 <tr>  <th style="width:3px;  "    >  </th>
        <td style="text-align:center;  color:black;  border:0px ; height: 20px;  ">

       	 
       	<p style="  font-size:12px; color:black; text-align:center;  margin-right:2px; background-color:yellow;"><strong>'.$comentario.' </strong> </p> 
   ...
   <tr>  <th style="width:3px;  "    >  </th>
        ...
        <p style="   font-size:12px; color:green;"><strong>Tiempo:</strong> '.$ltiempo.'</p>
   ...
   <tr>  <th style="width:3px;  "    >  </th>
        <td style="text-align: left;  color:black;  border:0px ;  height: 18px; ">
