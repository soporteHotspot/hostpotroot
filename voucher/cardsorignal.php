...
$Carpetaqr="QRHTML/";
$files = glob($Carpetaqr.'/*'); //obtenemos todos los nombres de los ficheros
...
$qrcode=$Carpetaqr.$nombre.".svg";
 ...
 $html= '<div class="w-33 h-40 flex flex-col justify-center gap-2 bg-indigo-500 rounded-lg shadow  ">
  <div class="flex  ">
<img alt="" src="[LOGO]" class="bg-purple-200 w-24 h-24 shrink-0 rounded-lg" />
     
    <div class="flex flex-col text-white">
     <div class="hover:bg-purple-300 bg-neutral-50 font-bold text-indigo-500 rounded p-2 italic"  >
   [ENCABEZADO]  
  </div>
 ...
 $html2= '<div class="w-33 h-40 flex flex-col justify-center gap-2 bg-indigo-500 rounded-lg shadow  ">
  <div class="flex  ">
 <img alt="" src="[LOGO]" class="bg-purple-200 w-24 h-24 shrink-0 rounded-lg" />
    <div class="flex flex-col text-white">
     <div class="hover:bg-purple-300 bg-neutral-50 font-bold text-indigo-500 rounded p-2 italic"  >
 ...
 foreach($arreglo as $Varx=>$Des) 
  {
        $html2=str_replace("[".$Varx."]",$Des,$html2);
  }
