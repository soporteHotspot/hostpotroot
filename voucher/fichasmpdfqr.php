...
$mpdf->AddPage();
 ...
 $mpdf->WriteHTML('<table style="margin:2px" class="tabla"> <tr>
    ...
    <th style="height:39px; font-size:18px" colspan="2">'.$textos.' </th>
    
  </tr>
  <tr>
      <th   rowspan="3" ><img class="code-QR" src="'.$Carpetaqr.$nombre.'.svg" />  </th>
    
     <td style="width:60%;  color:green;    border:1px solid orange;">'.$nombre.'</td>
  </tr>

  <tr>
    
    
    <td style="  color:blue;">'.$comentario.'</td>
  </tr>
  ...
  <tr>
    ...
    <td style=" color:blue;">'.$ltiempo.'</td>
...
$mpdf->WriteHTML('
  ...
  <tr>
      <th   rowspan="4" ><img class="code-QR" src="'.$Carpetaqr.$nombre.'.svg" />  </th>
 ...
 <tr>
    ...
    <td style="color:green; padding:1px; border:1px solid orange;"> '.$pass.'</td>
  </tr>
  <tr>
...
<table class="tabla"> <tr>
    ...
    <th style="height:39px; font-size:18px" colspan="2">No se encontraron registros </th>
    
  </tr>
  <tr>
      <th   rowspan="3" >Sin QR </th>
    
     <td style="width:60%; color:green;   border:1px solid orange;">'.$tipo.'</td>
  </tr>
