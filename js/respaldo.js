...
$('#loader').html('<div class="alert alert-info alert-dismissible fade show" role="alert"> <strong> Cargando datos  <i class="fa fa-spinner fa-spin fa-fw" aria-hidden="true"></i></strong></div>');
