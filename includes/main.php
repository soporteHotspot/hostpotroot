...
<div class="loading show">
 ...
 <div class="container">
  ...
  <p>Hotspot Mikrotik</p>
  <div class="card img-fluid" style="width:500px">
   
    <div class="card-img-overlay">
      <h4 class="card-title"><i class="fas fa-4x fa-address-card text-primary"></i></h4>
       
       <h2 ><i class="fas fa-4x fa-users text-success"></i></h2>
