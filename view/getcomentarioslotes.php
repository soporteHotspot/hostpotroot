  ...
  if ($API->connect($ip,$Usuario,$password)) {
    ...
    $comment=  explode(",",$arraycomment);
     echo '<select required   id="comentariosdeletelotes" name="comentario"  class="form-control" aria-label="Default select example">';
	   echo '<option     value="">Seleccione comentario</option>';
