        ...
        $fecha; 
          ...
          <!-- /.col -->
            ...
            <div class="info-box">
              ...
              <div class="info-box-content text-dark">
                <span class="info-box-text">Recaudacion neto   </span>
                <span class="info-box-number">
<?php
...
for ($i = 0; $i < $TotalReg; $i++) {   sleep(0.25);
	$users = $obtenerusers[$i];
	...
	if (isset($users['profile'])){			
		...
		if (isset($users['limit-uptime'])){			
			$ltiempo =converttime($users['limit-uptime']);
		}
		else {
			$ltiempo ="Ilimitado";
		}
	...
	echo '
                ...
                <tr  >
					...
					echo '
					 ...
					 <td class="text-center"><button   value="'.$nombre.'" type="button" class="btn btn-light border Mostrardatadelete " data-toggle="modal" data-target="#Modaldeletedata"><i class="fas fa-user-minus text-danger"></i></button>
